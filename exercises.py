...
def largest(x, y, z):
    return max(x, y, z)         # max() = built in python function; returns largest number from a given list. (Also works with characters and mixed data types...need further reading to understand ASCII values)
...
def calculate_tip(bill, tip):
    ...
    # round(number, digits)   number = the number to be rounded; digits(optional) = number of decimal digits to round to, default is 0.
    return round(bill * (tip / 100), 2)   


print('Exercise 7:', calculate_tip(50, 20))
# print('Exercise 7:', calculate_tip(132, 5))
# print('Exercise 7:', calculate_tip(234, 12))
...
def basic_calculator(x, y, operation):
    if operation == 'add':
        ...
        return "Try again! Invalid operation."
...
# print('Exercise 9 Result:', basic_calculator(10, 5, "sum"))